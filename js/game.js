...
window.onload = function(){
    //al cargarse la pagina seteamos el juego a mostrarse.

    /*******LUPA***************/
    //borramos el puntero del mouse
    ...
    document.addEventListener("mousemove",function(e){
        ...
        {
            //creamos el objeto imagen que servira para ser mostrado en la lupa.
            var image_object = new Image();
            image_object.src = $(".small").attr("src");//le pasamos el div
